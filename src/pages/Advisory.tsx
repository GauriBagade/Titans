...
const Advisory = () => {
  ...
  const weatherAlerts = checkWeatherAlerts(forecast, weather);
  ...
  }, [location, isWeatherLoading, requestLocation]);
  ...
  useEffect(() => {
    ...
    const interval = setInterval(async () => {
      ...
      try {
        ...
        const newAlerts = checkWeatherAlerts(forecast, weather);
  ...
  }, [isSubscribed, refreshWeather, forecast, weather, checkWeatherAlerts, showLocalNotification]);
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <div className="mt-1 flex items-center gap-2 text-farmer-sm text-muted-foreground">
            ...
            {isWeatherLoading && !displayLocation ? (
